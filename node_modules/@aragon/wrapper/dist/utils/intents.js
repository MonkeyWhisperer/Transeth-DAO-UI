...
.map(path=>path.map(_ref=>{let{to}=_ref;return to}))// Ignore the final intent target, as the path is everything "before" that target
...
.filter(_ref2=>{let{namespace}=_ref2;return(0,_kernel.isKernelAppCodeNamespace)(namespace)})}
