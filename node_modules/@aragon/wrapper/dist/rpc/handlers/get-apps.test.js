...
const initialApps=[{appId:"coolApp",kernelAddress:"0x123",contractAddress:"0xcoolApp",abi:"abi for coolApp",roles:"roles for coolApp",isForwarder:!1,name:"Cool App",proxyAddress:"0x456",icons:[{src:"icon_link"}]}],appsMock=new _rxjs.BehaviorSubject(initialApps),identifiersMock=(0,_rxjs.of)({"0x456":"cool identifier","0x789":"voting identifier"}),result=await(0,_getApps.default)({params:["observe","all"]},{},{apm:{getContentPath:(content,path)=>`url/${path}`},apps:appsMock,appIdentifiers:identifiersMock}),expectedInitialApps=[{abi:"abi for coolApp",appAddress:"0x456",appId:"coolApp",appImplementationAddress:"0xcoolApp",identifier:"cool identifier",isForwarder:!1,kernelAddress:"0x123",name:"Cool App",icons:[{src:"url/icon_link"}],roles:"roles for coolApp"}],expectedEndApps=[].concat(expectedInitialApps,{abi:"abi for votingApp",appAddress:"0x789",appId:"votingApp",appImplementationAddress:"0xvotingApp",identifier:"voting identifier",isForwarder:!0// force cache invalidation
,kernelAddress:"0x123",name:"Voting App",icons:[{src:"url/icon_link"}],roles:"roles for votingApp"});let emitIndex=0;result.subscribe(value=>{0===emitIndex?t.deepEqual(value,expectedInitialApps):1===emitIndex?t.deepEqual(value,expectedEndApps):t.fail("too many emissions"),emitIndex++});// We need apps' second emission to fire after the identifiers have emitted,
