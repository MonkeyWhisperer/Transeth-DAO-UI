...
if(!fullMethodSignature)return method.name===methodSignature;const currentParameterTypes=method.inputs.map(({type})=>type),currentMethodSignature=`${method.name}(${currentParameterTypes.join(",")})`;return currentMethodSignature===methodSignature});return methodAbiFragment}
