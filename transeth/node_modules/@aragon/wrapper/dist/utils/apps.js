...
}),exports.findAppMethodFromData=findAppMethodFromData,exports.findAppMethodFromSignature=findAppMethodFromSignature,exports.knownAppIds=exports.apmAppId=void 0;var _ethEnsNamehash=require("eth-ens-namehash"),_web3Utils=require("web3-utils");const apmAppId=appName=>(0,_ethEnsNamehash.hash)(`${appName}.aragonpm.eth`);exports.apmAppId=apmAppId;function findAppMethod(app,methodTestFn,{allowDeprecated}={}){const{deprecatedFunctions,functions}=app||{};let method;// First try to find the method in the current functions
 ...
 */function findAppMethodFromData(app,data,{allowDeprecated=!0}={}){const methodId=data.substring(2,10);return findAppMethod(app,method=>(0,_web3Utils.soliditySha3)(method.sig).substring(2,10)===methodId,{allowDeprecated})}/**
 ...
 * @param  {boolean} [options.allowDeprecated] Allow deprecated functions to be returned. Defaults to true.
 * @return {Object|void} Method with radspec notice and function signature, or undefined if none was found
 */function findAppMethodFromSignature(app,methodSignature,{allowDeprecated=!0}={}){// Is the given method a full signature, e.g. 'foo(arg1,arg2,...)'
