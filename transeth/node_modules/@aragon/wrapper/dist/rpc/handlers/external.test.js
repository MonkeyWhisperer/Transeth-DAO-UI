"use strict";var _interopRequireWildcard=require("@babel/runtime/helpers/interopRequireWildcard"),_interopRequireDefault=require("@babel/runtime/helpers/interopRequireDefault"),_ava=_interopRequireDefault(require("ava")),_proxyquire=_interopRequireDefault(require("proxyquire")),_sinon=_interopRequireDefault(require("sinon")),_events=require("events"),configurationKeys=_interopRequireWildcard(require("../../configuration/keys")),eventsUtils=_interopRequireWildcard(require("../../utils/events"));_ava.default.beforeEach(t=>{const configurationStub={getConfiguration:_sinon.default.stub()},utilsStub={events:eventsUtils},external=(0,_proxyquire.default)("./external",{"../../configuration":configurationStub,"../../utils":utilsStub});t.context={external,configurationStub,utilsStub}}),_ava.default.afterEach.always(()=>{_sinon.default.restore()}),(0,_ava.default)("should return the correct tx path from external tx intent",async t=>{const{external}=t.context,targetAddr="0x123",targetMethodAbiFragment=[{name:"foo"}],targetParams=[8],mockPath=[{to:"0x123",data:"0x456"}];t.plan(3);// arrange
