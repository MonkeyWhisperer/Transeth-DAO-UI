"use strict";var _interopRequireWildcard=require("@babel/runtime/helpers/interopRequireWildcard");Object.defineProperty(exports,"__esModule",{value:!0// force cache invalidation
}),exports.call=call,exports.intent=intent,exports.events=events,exports.pastEvents=pastEvents;var _rxjs=require("rxjs"),_operators=require("rxjs/operators"),_configuration=require("../../configuration"),configurationKeys=_interopRequireWildcard(require("../../configuration/keys")),_events=require("../../utils/events");function call(request,proxy,wrapper){const web3=wrapper.web3,[address,methodAbiFragment,...params]=request.params,contract=new web3.eth.Contract([methodAbiFragment],address);return contract.methods[methodAbiFragment.name](...params).call()}async function intent(request,proxy,wrapper){const[address,methodAbiFragment,...params]=request.params,transactionPath=await wrapper.getExternalTransactionPath(address,methodAbiFragment,params);return wrapper.performTransactionPath(transactionPath,{external:!0})}function events(request,proxy,wrapper){const web3=wrapper.web3,[address,jsonInterface]=request.params,contract=new web3.eth.Contract(jsonInterface,address);// `external_events` RPC compatibility with aragonAPI versions:
